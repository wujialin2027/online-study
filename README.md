...
> 线上演示环境已**关闭自助注册**（防陌生人灌数据），请用下面的账号登录。

**推荐用这组**（演示数据最完整：课程 / 作业 / 成绩 / 论坛 / 课件都齐全）：
...
**初始账号**（由 `init.sql` 与 `sql/demo_data*.sql` 初始化，密码统一 `123456`）：

| 角色 | 账号 | 密码 |
|---|---|---|
| 管理员 | `admin` | `123456` |
| 教师 | `teacher1` ~ `teacher5` | `123456` |
| 学员 | `student1`、`student2`、`student4` ~ `student10` | `123456` |
